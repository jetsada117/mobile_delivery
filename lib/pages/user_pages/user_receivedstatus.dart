...
class ReceivedStatusPage extends StatefulWidget {
  const ReceivedStatusPage({super.key});

  @override
  State<ReceivedStatusPage> createState() => _ReceivedStatusPageState();
}

class _ReceivedStatusPageState extends State<ReceivedStatusPage> {
  // โทนสีเดียวกับหน้าที่เหลือ
